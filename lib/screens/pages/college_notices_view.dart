...
/// Mirrors the "Announcements" box on sliet.ac.in — the three latest notices,
/// given prominence above the full list.
///
/// The site scrolls these; here they are simply listed, which is easier to
/// read and doesn't move out from under a tap.
class _AnnouncementsStrip extends StatelessWidget {
  final List<CollegeNotice> notices;
  final ValueChanged<CollegeNotice> onOpen;

  const _AnnouncementsStrip({required this.notices, required this.onOpen});
